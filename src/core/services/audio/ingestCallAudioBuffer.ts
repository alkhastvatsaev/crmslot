 ...
 */
export async function ingestCallAudioBuffer(params: IngestCallAudioParams): Promise<IngestCallAudioResult> {
  ...
  try {
    ...
    console.warn("[ingestCallAudioBuffer] Firestore:", e);
  }
  ...
  }).catch((err) => console.error("[ingestCallAudioBuffer] Traitement async:", err));
