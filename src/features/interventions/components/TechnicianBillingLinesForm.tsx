...
export default function TechnicianBillingLinesForm({
  ...
  if (terrain) {
    const editIndex = 0;
    const line = lines[editIndex] ?? emptyLine();
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col justify-center gap-2 overflow-hidden">
          <input
            ...
            onChange={(e) => updateLine(editIndex, "description", e.target.value)}
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) => updateLine(editIndex, "quantity", Number(e.target.value))}
            ...
            <input
              ...
              onChange={(e) =>
                updateLine(editIndex, "unitPriceCents", Math.round(Number(e.target.value) * 100))
              }
