...
import { generateInterventionReport } from "@/features/billing/generateInterventionReport";
...
export default function AdminValidationPanel() {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(
        ...
        data.sort((a, b) => {
          const tA =
            typeof a.createdAt === "string"
              ...
              : (a.createdAt as { toMillis?: () => number } | null | undefined)?.toMillis?.() || 0;
          const tB =
            typeof b.createdAt === "string"
              ? new Date(b.createdAt).getTime()
              : (b.createdAt as { toMillis?: () => number } | null | undefined)?.toMillis?.() || 0;
          return tB - tA;
        });
      ...
      (error) => {
        logger.error("Erreur lors du chargement des interventions:", {
