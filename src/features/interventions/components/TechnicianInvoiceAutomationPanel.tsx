...
export default function TechnicianInvoiceAutomationPanel() {
  return (
    <div
      data-testid="technician-invoice-automation-panel"
      className={`${GLASS_PANEL_BODY_SCROLL_COMPACT} flex flex-col gap-3`}
    >
      <h2 className="sr-only">Facturation automatique</h2>
      <p className="sr-only">
        Après clôture avec au moins une photo chantier et signature client sur le serveur, une
        fonction Cloud génère un PDF facture sur Storage et met le statut à Facturé. La checklist
        doit être complète avant génération.
      </p>
