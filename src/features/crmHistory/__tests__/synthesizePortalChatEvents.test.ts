import { synthesizePortalChatEvents } from "@/features/crmHistory/synthesizePortalChatEvents";
import type { PortalChatDoc } from "@/features/backoffice";
import type { Intervention } from "@/features/interventions";

describe("synthesizePortalChatEvents", () => {
  it("maps staff chat to ivana_chat_message", () => {
    const msg: PortalChatDoc = {
      id: "m1",
      companyId: "co1",
    ...
    const evts = synthesizePortalChatEvents([msg], new Map([["iv1", iv]]));
