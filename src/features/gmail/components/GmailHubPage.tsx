...
export default function GmailHubPage({ slotIndex = GMAIL_HUB_SLOT_INDEX }: Props) {
  ...
  return (
    <AdaptiveTriplePanelLayout
      ...
      mobileLeftLabel={String(t("gmail.hub.mobile.rail_left"))}
      mobileCenterLabel={String(t("gmail.hub.mobile.rail_center"))}
      mobileRightLabel={String(t("gmail.hub.mobile.rail_right"))}
      centerPadding={false}
      rightPadding={false}
      left={
