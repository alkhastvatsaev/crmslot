...
Timeline commentaires + WhatsApp Twilio serveur.

## Points d'entrée

| Fichier      | Rôle                                                                        |
| ------------ | --------------------------------------------------------------------------- |
| \`index.ts\` | **Barrel public** — imports cross-feature via \`@/features/communications\` |
...
```bash
npx jest src/features/communications --no-coverage
```
